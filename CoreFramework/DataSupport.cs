...
namespace CoreFramework
{
    public class DataSupport
    {
        ...
        public static DataSet RunDataSetFast(String sql, Dictionary<String, Object> parameters)
        {
            if (IsUnitTest() && !IsTestMode())
                throw new AccessViolationException();
            DataSet result = null;
        ...
        public static String GetNextMenuCode(String menu, String menu_prefix)
        {
            ...
            DataSet ds = DataSupport.RunDataSet(String.Format("SELECT menu_current FROM MENU WHERE menu_id = '{0}' ", menu));
        ...
        public static String GetNextMenuCodeInt(String menu)
        {
            ...
            DataSet ds = DataSupport.RunDataSet(String.Format("SELECT menu_current FROM MENU WHERE menu_id = '{0}' ", menu) + UpdateMenuCode(menu));
            String next_value = ds.Tables[0].Rows[0][0].ToString();
            result = next_value;
            return result;
        }
        ...
        public static Dictionary<String, String> ConvertToStringValues(Dictionary<String, Object> list)
        {
