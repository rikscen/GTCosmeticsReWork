...
namespace CoreFramework
{
    public static class Utils
    {
        ...
        public static DataSet ToDataSet(this SqlDataReader reader)
        {
        ...
        public static DataSet GetDatasetFast(String sql, params Object[] parameters)
        {
        ...
        public static int ExecuteRunNonQuery(String sql, params Object[] parameters)
        {
            return ExecuteRunNonQuery(sql, Utils.ToDict(parameters));
        }
        public static int ExecuteRunNonQuery(String sql, Dictionary<String, Object> parameters)
        {
        ...
        public static Dictionary<String, DataRow> BuildIndexSQL(String SQL, String ColumnName)
        {
